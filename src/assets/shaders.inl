...
{.path = "data/shaders/background.glsl", .size = 599, .data =
...
{.path = "data/shaders/mesh.glsl", .size = 4028, .data =
    "/*\n"
...
{.path = "data/shaders/model3d.glsl", .size = 1317, .data =
    "uniform   mat4  u_model;\n"
    "uniform   mat4  u_proj;\n"
...
{.path = "data/shaders/pos_data.glsl", .size = 811, .data =
