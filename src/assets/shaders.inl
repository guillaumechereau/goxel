...
{.path = "data/shaders/background.glsl", .size = 664, .data =
    "#ifdef GL_ES\n"
...
{.path = "data/shaders/mesh.glsl", .size = 4095, .data =
    "/*\n"
...
{.path = "data/shaders/model3d.glsl", .size = 2680, .data =
...
{.path = "data/shaders/pos_data.glsl", .size = 878, .data =
    "#ifdef GL_ES\n"
    "    precision mediump float;\n"
    "#else\n"
    "    #define highp\n"
...
{.path = "data/shaders/shadow_map.glsl", .size = 706, .data =
    "#ifdef GL_ES\n"
    "    precision mediump float;\n"
    "#else\n"
    "    #define highp\n"
